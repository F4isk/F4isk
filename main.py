...
URL = 'https://api.telegram.org/bot5090296218:AAGPNA4Qc6kNYt-0VL8rFBQlnhhENzyfq50/'


# https://api.telegram.org/bot5090296218:AAGPNA4Qc6kNYt-0VL8rFBQlnhhENzyfq50/setWebhook # удаление webhook
# https://api.telegram.org/bot5090296218:AAGPNA4Qc6kNYt-0VL8rFBQlnhhENzyfq50/setWebhook?url=https://9658-94-29-124-37.ngrok.io # создание webhook
# https://api.telegram.org/bot5090296218:AAGPNA4Qc6kNYt-0VL8rFBQlnhhENzyfq50/getWebhookinfo # информация о webhook
        ...
        if "'text'" in st_r or "document" in st_r or "photo" in st_r:
            if "'text'" in st_r:
                ...
                if where_name==2 and 'photo' in st_r:
                    ...
                    url_dir_image = "https://api.telegram.org/file/bot5090296218:AAGPNA4Qc6kNYt-0VL8rFBQlnhhENzyfq50/" + dir_image  # это путь к картинке
                ...
                # -------------------------------------------
                '''
                bot_token1 = '5090296218:AAGPNA4Qc6kNYt-0VL8rFBQlnhhENzyfq50'
                chat_id1 = "1292677678"
